...
public class TencentMusicAdapter extends RecyclerView.Adapter<TencentMusicAdapter.ViewHolder> {

    private Context mContext;
    private List<TencentMusicBean> tencentMusicBeans;
    ...
    public TencentMusicAdapter(List<TencentMusicBean> tencentMusicBeans, List<Song> songs){
        this.tencentMusicBeans = tencentMusicBeans;
        this.songs = songs;
    }
    @Override
    ...
    public void onBindViewHolder(ViewHolder holder,int position){
        TencentMusicBean musicBean = tencentMusicBeans.get(position);
        holder.title.setText(musicBean.getSongname());
        holder.artist.setText(musicBean.getAlbumname());
    }

    @Override
    public int getItemCount(){
        return tencentMusicBeans.size();
    }
}
